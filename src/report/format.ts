import type { ConformanceReport, ConformanceCheck } from "./types.js";

/**
 * Shields.io style badge URL for conformance score.
 */
export function badgeSnippet(score: number): string {
 ...
 */
export function formatMarkdown(report: ConformanceReport): string {
  const lines: string[] = [];
